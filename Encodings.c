...
static nodeInt64_t *add_rejected_clauses(SATSolver_t *solver, argFramework_t *framework, activeArgs_t *activeArgs, uint32_t argument)
{
...
static void add_rejected_clauses_per_attacker(SATSolver_t *solver, activeArgs_t *activeArgs, uint32_t argument, uint32_t attacker, nodeInt64_t *rejection_reason_clause)
{
...
static void add_conflict_free_per_attacker(SATSolver_t *solver, activeArgs_t *activeArgs, uint32_t argument, uint32_t attacker)
{
	//create disjunction
...
static void add_defense_per_attacker(SATSolver_t *solver, activeArgs_t *activeArgs, uint32_t argument, uint32_t attacker)
{
	if (argument == attacker)
	{
		return;
...
static void add_admissible(SATSolver_t *solver, argFramework_t *framework, activeArgs_t *activeArgs, uint32_t argument)
{
